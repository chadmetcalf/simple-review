...
RSpec.describe RubricsController, :type => :controller do
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created rubric as @rubric" do
        post :create, {:rubric => valid_attributes}, valid_session
        expect(assigns(:rubric)).to be_a(Rubric)
        expect(assigns(:rubric)).to be_persisted
      end

      it "redirects to the created rubric" do
        post :create, {:rubric => valid_attributes}, valid_session
        expect(response).to redirect_to(Rubric.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved rubric as @rubric" do
        post :create, {:rubric => invalid_attributes}, valid_session
        expect(assigns(:rubric)).to be_a_new(Rubric)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested rubric" do
        rubric = Rubric.create! valid_attributes
        put :update, {:id => rubric.to_param, :rubric => new_attributes}, valid_session
        rubric.reload
    ...
    describe "with invalid params" do
      it "assigns the rubric as @rubric" do
        rubric = Rubric.create! valid_attributes
        put :update, {:id => rubric.to_param, :rubric => invalid_attributes}, valid_session
        expect(assigns(:rubric)).to eq(rubric)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the rubrics list" do
      rubric = Rubric.create! valid_attributes
      delete :destroy, {:id => rubric.to_param}, valid_session
      expect(response).to redirect_to(rubrics_url)
    end
  end
